 ...
 */
   ...
   * Portfolio buttons
   */
  function switchInfo(n, no) {
    let overviews = document.getElementsByClassName("overview");
    let techs = document.getElementsByClassName("tech");
    let buttons = document.getElementsByClassName("portfolio-buttons")[no].children;
    let overviewButton = buttons[0];
    let techButton = buttons[1];
    ...
    if (n == 1) {
      overviews[no].classList.remove("active")
      techs[no].classList.add("active")
    }

    else if (n == 0) {
      overviews[no].classList.add("active")
      techs[no].classList.remove("active")
    }
  }
  ...
  */
  ...
  function showInterest(number) {
    let interests = document.getElementsByClassName("interest-info");
    for (let i=0; i<interests.length; i++) {
      if (i == number) {
        interests[i].classList.remove("hidden");
      }
      else {
        interests[i].classList.add("hidden");
      }
    }
  }